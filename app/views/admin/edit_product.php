    ...
    <?php if ($product != null): ?>
        <div id="message-red">
            <table border="0" width="100%" cellpadding="0" cellspacing="0">
                <tr>
                    <td class="red-left">Error. Please try again.</a></td>
            ...
            <div id="content-table-inner">
                ...
                <table border="0" width="100%" cellpadding="0" cellspacing="0">
                    <tr valign="top">
                        <td>
                            <!-- start id-form -->
                            <form  enctype="multipart/form-data" method="post" action="<?php echo url('admin_products/edit_product'); ?>">
                                <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                                    ...
                                    <tr>
                                        <th>&nbsp;</th>
                                        <td valign="top">
                                            <input type="submit" value="Edit" class="form-submit" name='submit' />
                                            <a href="<?php echo url('admin_products'); ?>" class="form-reset" ></a>
                                            <input type="hidden" value="<?php echo ($product) ? $product->getId() : ""; ?> " name='data[id]' />
                                        </td>
                                        <td></td>
                                    </tr>
                                </table>
