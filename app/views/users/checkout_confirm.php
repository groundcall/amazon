                ...
                <li id="opc-review" class="section slide6 allow active">
                    ...
                    <div id="checkout-step-review" class="step a-item">
                        <div class="order-review" id="checkout-review-load"><br/><br/>
                            <form action="<?php echo url('checkout/show_order_confirmation'); ?>" method="post">
                                <fieldset>
                                        ...
                                        <tfoot>
                                            ...
                                            <tr class="first last">
                                                <td colspan="50" class="a-right last">
                                                    <button type="button" class="button" onclick="window.location='<?php echo url('products/'); ?>'"><span><span>Cancel</span></span></button>
                                                    <button type="submit" class="button"><span><span>Place Order</span></span></button>
