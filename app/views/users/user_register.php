...
<div class="main-container col1-layout">
    <div class="main">
        <?php if (isset($_SESSION['registration_ok']) && $_SESSION['registration_ok'] == 'ok'): ?>
            <div id="messages_product_view">
                <ul class="messages">
                    <li class="success-msg">
                        <ul>
                            <li><span>Registration successful. Please check your email.</span></li>
                        </ul>
                    </li>
                </ul>
            </div>
            <?php $_SESSION['registration_ok'] = null; ?>
        <?php endif; ?>
