...
<div class="col-right sidebar">
    <div class="block block-cart">
        ...
        <?php else: ?>
            ...
            <div class="actions">
                <button type="button" title="Checkout" class="button" <?php echo ($total <= 0) ? 'disabled' : ''; ?> onclick='window.location = "<?php echo url('checkout/'); ?>"'><span><span>Checkout</span></span></button>
            </div>
